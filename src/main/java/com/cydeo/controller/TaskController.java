...
public class TaskController {
    ...
    public ResponseEntity<ResponseWrapper> deleteTask(@PathVariable("taskId") Long taskId){
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseWrapper("Task is successfully deleted",HttpStatus.OK));
    ...
    public ResponseEntity<ResponseWrapper> employeePendingTasks(){
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseWrapper("Tasks are successfully retrieved",taskDTOList,HttpStatus.OK));
